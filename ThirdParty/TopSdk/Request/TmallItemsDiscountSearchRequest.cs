...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class TmallItemsDiscountSearchRequest : BaseTopRequest<Top.Api.Response.TmallItemsDiscountSearchResponse>
    {
        /// <summary>
        ...
        {
            RequestValidator.ValidateMaxValue("miaosha", this.Miaosha, 1);
            RequestValidator.ValidateMinValue("miaosha", this.Miaosha, 1);
