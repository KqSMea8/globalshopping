...
namespace Taobao.Baichuan.Link.Channel.TCP
{
    ...
    public class TcpServerChannel : ServerChannel
    {
        ...
        public delegate void IOWorker(ILog log, TcpServerChannel server, TcpClient tcpClient);
        ...
        private void AcceptSocket(TcpClient client)
        {
            ...
            ThreadPool.QueueUserWorkItem(o => 
                this._ioWorker(this.LoggerFactory.Create(logName), this, client));
        }
