...
namespace Baichuan.Api.Domain
{
    ...
    public class Product : TopObject
    {
        ...
        public List<Baichuan.Api.Domain.ProductExtraInfo> ProductExtraInfos { get; set; }
        ...
        public List<Baichuan.Api.Domain.ProductImg> ProductImgs { get; set; }
        ...
        public List<Baichuan.Api.Domain.ProductPropImg> ProductPropImgs { get; set; }
