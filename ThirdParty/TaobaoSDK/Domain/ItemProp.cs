...
namespace Baichuan.Api.Domain
{
    ...
    public class ItemProp : TopObject
    {
        ...
        public List<Baichuan.Api.Domain.Feature> Features { get; set; }
        ...
        public Baichuan.Api.Domain.ItemMaterialProp MaterialDo { get; set; }
        ...
        public List<Baichuan.Api.Domain.PropValue> PropValues { get; set; }
        ...
        public Baichuan.Api.Domain.ItemTaosirDO TaosirDo { get; set; }
