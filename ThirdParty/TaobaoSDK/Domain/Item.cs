...
namespace Baichuan.Api.Domain
{
    ...
    public class Item : TopObject
    {
        ...
        public Baichuan.Api.Domain.DeliveryTime DeliveryTime { get; set; }
        ...
        public Baichuan.Api.Domain.DescModuleInfo DescModuleInfo { get; set; }
        ...
        public Baichuan.Api.Domain.FoodSecurity FoodSecurity { get; set; }
        ...
        public List<Baichuan.Api.Domain.ItemImg> ItemImgs { get; set; }
        ...
        public Baichuan.Api.Domain.LocalityLife LocalityLife { get; set; }
        ...
        public Baichuan.Api.Domain.MpicVideo MpicVideo { get; set; }

        /// <summary>
        /// 家装分阶段价格数据结构
        /// </summary>
        [XmlElement("ms_payment")]
        public Baichuan.Api.Domain.MsPayment MsPayment { get; set; }
        ...
        public Baichuan.Api.Domain.PaimaiInfo PaimaiInfo { get; set; }
        ...
        public List<Baichuan.Api.Domain.PropImg> PropImgs { get; set; }
        ...
        [XmlArray("videos")]
        [XmlArrayItem("video")]
        public List<Baichuan.Api.Domain.Video> Videos { get; set; }
