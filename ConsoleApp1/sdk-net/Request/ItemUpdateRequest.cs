...
namespace Top.Api.Request
{
    ...
    public class ItemUpdateRequest : BaseTopRequest<ItemUpdateResponse>, ITopUploadRequest<ItemUpdateResponse>
    {
        ...
        /// </summary>
        public Nullable<long> InteractiveId { get; set; }
        ...
        /// 淘宝租赁扩展信息
        /// </summary>
        public string LeaseExtendsInfo { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("interactive_id", this.InteractiveId);
            ...
            parameters.Add("lease_extends_info", this.LeaseExtendsInfo);
